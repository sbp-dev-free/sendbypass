...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/mo3tafa/.cursor/extensions/wallabyjs.console-ninja-1.0.448/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2011cdceddd046e7a9577eBB9aU01UXgdVCAJTAw5QCgNSU1NX', mode: 'build'}); } catch(cjsError) { try { import('file:///home/mo3tafa/.cursor/extensions/wallabyjs.console-ninja-1.0.448/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2011cdceddd046e7a9577eBB9aU01UXgdVCAJTAw5QCgNSU1NX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
