...
const outboxShippingRequestGetParams: RequestGet = {
  side: RequestSideSchema.Enum.SENT,
  type: RequirementTypeEnum.Enum.SHIPPING,
};

const SentShippingRequestsPage = () => {
  const {
    ...
    url: URLS.requests(),
    config: {
      params: outboxShippingRequestGetParams,
    },
    isProtected: true,
  });
...
export default SentShippingRequestsPage;
